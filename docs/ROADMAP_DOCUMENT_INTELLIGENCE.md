...
Migration V32 menambahkan `document-family-v1` sebagai hard gate setelah coverage/template dan sebelum retrieval. Adaptive XLSX screening menginventarisasi seluruh sheet lalu membaca sheet struktural yang relevan meskipun berada setelah empat sheet pertama. Registry family membatasi parameter secara deterministik, role dokumen membatasi authority fakta, confidence keputusan dipisahkan dari skor retrieval/mapping, dan Grade eligibility menahan family tidak relevan, coverage rendah, ambiguity, serta template. UI tidak lagi memakai Grade E sebagai fallback. Evaluasi sintetis mencapai 100% family accuracy, Top-5 100%, Top-1 100%, false-primary 0%, dan overgrade non-grade 0%; 291 backend tests serta 56 subtests lulus. Kalibrasi pada minimal 50 dokumen berlabel ahli tetap menjadi gate sebelum shadow/pilot.
